              ...
              <section className="patient-gallery-hero">
                <div className="gallery-wrapper-grid">
                  <div className="custom-card-img text-overlay-style">
                    <div className="vector-scene-art recovery-room">
                      <div className="heart-pulse-glow" />
                      <div className="shield-tick" />
                    </div>
                    <h4>Modern Post-Op Guidance</h4>
                  </div>
                  <div className="custom-card-img text-overlay-style">
                    <div className="vector-scene-art telehealth-care">
                      <div className="doctor-signal-waves" />
                      <div className="phone-ring-line" />
                    </div>
